...
import static org.firstinspires.ftc.teamcode.pure.MathFunctions.*;
import static org.firstinspires.ftc.teamcode.pure.Robot.*;
...
public class RoboMove {
    ...
    public static void followCurve (ArrayList<CurvePoint> allPoints, double followAngle){
        ...
        CurvePoint followMe = getFollowPointPath(allPoints, new Point((int)worldXPosition, (int)worldYPosition),
